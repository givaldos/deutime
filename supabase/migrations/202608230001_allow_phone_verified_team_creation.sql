-- WhatsApp-first onboarding: a confirmed Auth phone is a verified identity.
-- Preserve the guarded RPC, limits and owner trigger; only widen verification.
...
comment on function public.create_team_for_current_user(
  ...
  'Creates a team for the current email- or phone-verified user with serialized anti-abuse limits.';
