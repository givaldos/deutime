...
- [`DEC-RECOGNITION-MODEL`](decisions/DEC-RECOGNITION-MODEL.md) — `proposed`: R10 avalia cartões factuais derivados de súmula finalizada e resultado agregado do Craque, sem pontos ou ranking; implementação permanece bloqueada até compreensão e sinal mínimo da coorte.
