...
export default async function AthleteRegistrationPage({
  ...
  const loginDestination = teamRegistrationPath(slug);
          ...
          {teamLink ? (
            ...
            <>
              ...
              <Button asChild variant="ghost" className="mt-3 min-h-11 w-full rounded-xl">
                <Link href={teamRegistrationPath(slug)}>Voltar às opções de acesso</Link>
              </Button>
            </>
          ) : (
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-5">
        ...
        >
          <Link href={teamRegistrationPath(teamSlug, true)}>
